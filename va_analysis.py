...
parser.add_argument("--num_x", default=4, help="number aggregated states (maximum)")
parser.add_argument("--num_a", default=2, help="number of actions")
parser.add_argument("--num_s", default=8, help="number of ground states")
parser.add_argument("-r", action="store_true", help="randomize state and action space sizes")
parser.add_argument("--g", default=0.999, help="discount factor")
parser.add_argument("--tries", default=100000, help="maximum simulation steps")
parser.add_argument("--va_eps", default=1e-6, help="aggregation tolerance")
parser.add_argument("--eps", default=1e-7, help="simulation tolerance")
parser.add_argument("--steps", default=np.inf, help="value/policy iteration maximum steps")
parser.add_argument("--greedy_eps", default=1e-3, help="epsilon-greedy choice")
